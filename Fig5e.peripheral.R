...
# This code was used to identify "recurrent" 'Ctsl-dependent' and 'Ctsl-independent' TCRs 
# in 3 or more pooled spleen and lymph node CD4+ T cells from Fixed-β Ctsl+/+ mice (n = 4). 
...
write.table(sd2, file = "Fig5e.peripheral.txt",
